"""Serve NON_PRODUCTION Teacher OS API for AIEOS360-S03-I04-E2E.

Uses governed build_development_teacher_os_app with HUMAN synthetic teacher.
Shares the disposable PostgreSQL runtime with Student and Parent surfaces.
"""
...
def main() -> int:
    ...
    port = int(os.environ.get("AIEOS360_S03_I04_E2E_TEACHER_BACKEND_PORT", "8007"))
    host = os.environ.get("AIEOS360_S03_I04_E2E_TEACHER_BACKEND_HOST", "127.0.0.1")
