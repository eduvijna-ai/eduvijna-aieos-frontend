"""Deterministic learner-facing worksheet for AIEOS360-S03-I04-E2E.
...
evaluation, score, or correctness.
"""
...
WORKSHEET_TITLE = "I04 Parent OS Real-Stack Worksheet"
...
def deterministic_i04_worksheet_payload() -> dict[str, object]:
    return {
        "title": WORKSHEET_TITLE,
        "teacher_summary": "Deterministic I04 worksheet for Parent OS real-stack E2E.",
        "learning_objectives": [
            {
        ...
        "teacher_notes": "I04 E2E deterministic fixture — do not alter question ids.",
    }


def deterministic_i04_worksheet_model() -> WorksheetV1:
    return WorksheetV1.model_validate(deterministic_i04_worksheet_payload())
