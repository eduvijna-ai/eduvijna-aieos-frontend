"""Bootstrap disposable PostgreSQL 18 for AIEOS360-S03-I04-E2E.
...
def main() -> int:
    ...
    port = os.environ.get("AIEOS_TEST_PG_PORT", "55437")
    report_path = Path(
        os.environ.get(
    ...
    if external:
        ...
        conftest.CONTAINER_NAME = os.environ.get(
            "AIEOS360_S03_I04_E2E_PG_CONTAINER", "aieos-aieos360-s03-i04-e2e-pg"
        )
