"""Deterministic learner-facing worksheet for AIEOS360-S02-I04-E2E.
...
WORKSHEET_TITLE = "I04 Deterministic Evidence Worksheet"
...
def deterministic_i04_worksheet_payload() -> dict[str, object]:
    return {
        ...
        "teacher_summary": "Deterministic I04 evidence worksheet for Principal OS E2E.",
        "learning_objectives": [
            {
