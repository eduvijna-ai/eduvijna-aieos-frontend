"""Serve NON_PRODUCTION Student OS API for AIEOS360-S02-I04-E2E.
...
Shares the disposable PostgreSQL runtime with Teacher and Principal surfaces.
"""
...
def main() -> int:
    ...
    port = int(os.environ.get("AIEOS360_S02_I04_E2E_STUDENT_BACKEND_PORT", "8005"))
    host = os.environ.get("AIEOS360_S02_I04_E2E_STUDENT_BACKEND_HOST", "127.0.0.1")
    ...
    app = create_app(
        ...
        cursor_signing_key=b"aieos360-s02-i04-e2e-student-cursor",
