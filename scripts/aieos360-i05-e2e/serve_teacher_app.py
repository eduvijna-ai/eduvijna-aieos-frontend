"""Serve NON_PRODUCTION Teacher OS API for AIEOS360-S01-I05-E2E.

Uses governed build_development_teacher_os_app with HUMAN synthetic teacher.
Shares the disposable PostgreSQL runtime with the Student surface.
"""
...
def main() -> int:
    ...
    port = int(os.environ.get("AIEOS360_I05_E2E_TEACHER_BACKEND_PORT", "8002"))
    host = os.environ.get("AIEOS360_I05_E2E_TEACHER_BACKEND_HOST", "127.0.0.1")
