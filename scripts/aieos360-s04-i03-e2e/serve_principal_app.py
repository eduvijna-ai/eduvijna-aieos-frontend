"""Serve the NON_PRODUCTION Principal OS API for AIEOS360-S04-I03-E2E.
...
def main() -> int:
    ...
    port = int(
        os.environ.get("AIEOS360_S04_I03_E2E_PRINCIPAL_BACKEND_PORT", "8012")
    )
    host = os.environ.get(
    ...
    principal_scope = DevelopmentCoherentSchoolContextProvider()
    ...
    app = create_app(
        ...
        cursor_signing_key=b"aieos360-s04-i03-e2e-principal-cursor",
